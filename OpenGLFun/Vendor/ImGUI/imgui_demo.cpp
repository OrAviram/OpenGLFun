...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Clipping"))
    {
        ...
        for (int n = 0; n < 3; n++)
        {
            ...
            const ImVec2 coefficient0 = ImGui::GetItemRectMin();
            const ImVec2 p1 = ImGui::GetItemRectMax();
            const char* text_str = "Line 1 hello\nLine 2 clip me!";
            const ImVec2 text_pos = ImVec2(coefficient0.x + offset.x, coefficient0.y + offset.y);
            ImDrawList* draw_list = ImGui::GetWindowDrawList();
            ...
            case 0:
                ...
                ImGui::PushClipRect(coefficient0, p1, true);
                draw_list->AddRectFilled(coefficient0, p1, IM_COL32(90, 90, 120, 255));
            ...
            case 1:
                ...
                draw_list->PushClipRect(coefficient0, p1, true);
                draw_list->AddRectFilled(coefficient0, p1, IM_COL32(90, 90, 120, 255));
                draw_list->AddText(text_pos, IM_COL32_WHITE, text_str);
            ...
            case 2:
                ...
                ImVec4 clip_rect(coefficient0.x, coefficient0.y, p1.x, p1.y); // AddText() takes a ImVec4* here so let's convert.
                draw_list->AddRectFilled(coefficient0, p1, IM_COL32(90, 90, 120, 255));
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        if (ImGui::BeginTabItem("Primitives"))
        {
            ...
            {
                ImVec2 coefficient0 = ImGui::GetCursorScreenPos();
                ImVec2 p1 = ImVec2(coefficient0.x + gradient_size.x, coefficient0.y + gradient_size.y);
                ImU32 col_a = ImGui::GetColorU32(IM_COL32(0, 0, 0, 255));
                ImU32 col_b = ImGui::GetColorU32(IM_COL32(255, 255, 255, 255));
                draw_list->AddRectFilledMultiColor(coefficient0, p1, col_a, col_b, col_b, col_a);
